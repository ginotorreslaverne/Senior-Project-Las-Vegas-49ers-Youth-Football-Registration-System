...
// Purpose: 
/* 
Admin Backend Devleopment for Senior Project: 
Admin's that makes it easier for the Admin's to view, access, and edit the database. 
Specifically with being able to see the players on the database, edit the information in the database, and remove players from the registration database.
*/
//------------------------------------------------------------------------------------------------------------------------
#include <iostream>
#include <sqlite3.h>
...
int main() {
    sqlite3 *db;
    int exit = sqlite3_open("players.db", &db); // Ensure database name matches parents' backend
